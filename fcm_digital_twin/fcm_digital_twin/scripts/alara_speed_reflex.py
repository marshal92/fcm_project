...
class AlaraSpeedReflex(Node):
    def __init__(self):
        ...
        self.rad_threshold = 30.0        
        self.normal_speed_pct = 35.0  
        self.boost_speed_pct = 100.0  
        ...
        self.timer_check = self.create_timer(0.25, self.check_reflex)
        self.get_logger().info("ALARA Native Speed Limit Reflex (Optimized) started!")

        self.create_timer(1.0, self._init_speed, callback_group=None)
